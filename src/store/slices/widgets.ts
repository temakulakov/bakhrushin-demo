...
const initialState: IWidget[] = [
    { id: 0, title: "Виджет 1", imageUrl: "https://placehold.jp/816x860.png", links: "/", type: "Про", description: "Сегодня в фондах музея представлено более 1,5 млн. экспонатов. Это эскизы декораций, фотографии, костюмы актёров и многое другое", backgroundColor: "#F5E9BC", buttonText: "Расмотреть далее"},
