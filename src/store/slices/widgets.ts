...
const initialState: IWidget[] = [
    { id: 0, title: "Виджет 1", imageUrl: "https://placehold.jp/816x860.png", links: "/", type: "Про", description: "Описание виджета 1", backgroundColor: "#F5E9BC", buttonText: "Расмотреть далее"},
    { id: 1, title: "Виджет 2", imageUrl: "https://placehold.jp/816x860.png", links: "/", type: "Про", description: "Описание виджета 2", backgroundColor: "#8a65b6", buttonText: "Расмотреть далее"},
